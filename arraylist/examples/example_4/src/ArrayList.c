 ...
 */
 //La estructura arrayList son solo 3 elementos
...
int al_contains(ArrayList* this, void* pElement)
{
    ...
    {
        returnAux = 0;
        for(index=0;index<al_len(this);index++)
        {
...
{
    ArrayList* returnAux = NULL;
    ArrayList* auxThis = al_newArrayList();
    void* aux;
    int i;
    if(this!=NULL && (this->size < this->reservedSize ||
    this->size == this->reservedSize) && auxThis!=NULL)
    {
        for(i=0;i<al_len(this);i++)
        {
            aux = realloc(this->pElements, ((this->reservedSize)+i)*sizeof(void*));
            if(!(al_add(auxThis, aux)))
            {
                returnAux = NULL;
            }else
            {
...
int resizeUp(ArrayList* this)
{
    int returnAux = -1;
    void* aux;
    aux = realloc(this->pElements, ((this->reservedSize)+AL_INCREMENT)*sizeof(void*));//1ºparametro: parametro a realocar, 2ºparametro: parametro a tamaño que desea agrandar
    if(aux!=NULL)
    {
        returnAux = 0;
